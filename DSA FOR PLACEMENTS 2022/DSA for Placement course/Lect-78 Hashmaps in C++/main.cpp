...
// USE OF UNORDERED MAP WITH ARRAY FOR STORING VALUE AS KEY FROM ARRAY AND COUNTING NUMBER OF TIMES THE KEY IS REPEATING
 
 
 //CODE:
 
int arr[] = {7,7,7,1,7,1,1,0,3,3,3,3,5,5,5,5};
